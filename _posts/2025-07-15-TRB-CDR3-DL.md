...
> {% include alert.html type="warning" content="These cancer files were obtained from the **GDC CPTAC Lung** cohort and include **both adenocarcinoma and squamous cell carcinoma** types combined." %}
...
```
> {% include alert.html type="warning" content="Result? Still poor generalization. Slightly better F1 but no significant boost." %}
---
